...
struct Country: Identifiable, Equatable {
    ...
    let name: String
    let dial: String
    /// Length of the national significant number — the digits after the dial code, with any
...
let COUNTRIES: [Country] = [
    .init(iso: "AT", name: "Austria", dial: "+43", nsnMin: 6, nsnMax: 13,
          flag: bandsH(0xED2939, 0xFFFFFF, 0xED2939), sample: "664 123456"),
    ...
    .init(iso: "BE", name: "Belgium", dial: "+32", nsnMin: 8, nsnMax: 9,
    ...
    .init(iso: "DE", name: "Germany", dial: "+49", nsnMin: 6, nsnMax: 11,
    ...
    .init(iso: "ES", name: "Spain", dial: "+34", nsnMin: 9, nsnMax: 9,
          ...
          sample: "612 34 56 78"),
    .init(iso: "FI", name: "Finland", dial: "+358", nsnMin: 5, nsnMax: 12,
    ...
    .init(iso: "GB", name: "United Kingdom", dial: "+44", nsnMin: 9, nsnMax: 10,
    ...
    .init(iso: "HU", name: "Hungary", dial: "+36", nsnMin: 8, nsnMax: 9,
          flag: bandsH(0xCD2A3E, 0xFFFFFF, 0x436F4D), sample: "20 123 4567"),
    .init(iso: "IE", name: "Ireland", dial: "+353", nsnMin: 7, nsnMax: 9,
          flag: bandsV(0x169B62, 0xFFFFFF, 0xFF883E), sample: "85 012 3456"),
    .init(iso: "IT", name: "Italy", dial: "+39", nsnMin: 6, nsnMax: 11,
    ...
    .init(iso: "LU", name: "Luxembourg", dial: "+352", nsnMin: 4, nsnMax: 11,
    ...
    .init(iso: "SE", name: "Sweden", dial: "+46", nsnMin: 7, nsnMax: 13,
